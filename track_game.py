...
class soccer_game:
    def __init__(self):
        ...
        self.line_direction = get_info.get_line_direction()
            ...
            while (True):
                ...
                if counter % 1 == 0:
                    ...
                    if all_ymax:
                        ...
                        ymin_min = max(all_xmin)
                        ymax_max = max(all_ymax)
                        ymin_min = min(all_ymin)

                        if soccer_game_curr.line_direction == 1:
                            cv2.line(image_np, (0, ymax_max), (width, ymax_max), (255, 0, 0), 2)
                            cv2.line(image_np, (0, ymin_min), (width, ymin_min), (0, 0, 255), 2)
                        elif soccer_game_curr.line_direction == 2:
                            cv2.line(image_np, (xmax_max, 0), (xmax_max, height), (255, 0, 0), 2)
                            cv2.line(image_np, (ymin_min, 0), (ymin_min, height), (0, 0, 255), 2)
                        elif soccer_game_curr.line_direction == 3:
                            pass
                        else:
                            print('wrong line direction input')
